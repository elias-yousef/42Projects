...
: [Errno 13] Permission denied: '{fileName}'", file=sys.stderr)
                    print("Data not saved.")
        except FileNotFoundError:
            print(f"[STDERR] Error opening file '{sys.argv[1]}': \
[Errno 2] No such file or directory: '{sys.argv[1]}'", file=sys.stderr)
        except PermissionError:
            print(f"[STDERR] Error opening file '{sys.argv[1]}'\
: [Errno 13] Permission denied: '{sys.argv[1]}'", file=sys.stderr)
            print("Data not saved.")
