...
def validate_arguments(
        ...
        ) -> tuple[int, int, bool, int, int, int, int, int | None]:
    ...
    try:
        ...
        if_error = True
        print("PERFECT must be 'True/true' or 'False/false'")
    ...
    return width, height, is_perfect, entry_x, entry_y, exit_x, exit_y, seed
...
def main() -> None:
    ...
    (width, height, is_perfect, entry_x,
        entry_y, exit_x, exit_y, seed) = validate_arguments(argument)
        ...
        if num == 1:
            ...
            with open(output_file_path, "w") as output:
                for row in arr_numbers:
                    ...
                    output.write("".join(line_chars).upper() + "\n")
                output.write("\n" + argument["ENTRY"] + "\n")
